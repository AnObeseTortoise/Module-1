...
#number of loans in the loan_costs data set
...
# YOUR CODE HERE!
avg_loan = total_loan / number_of_loans
print(avg_loan)
...
def calc_pv(ann_disc_rt): 
    
    fv_new_loan = new_loan.get("future_value")
    rm_new_loan = new_loan.get("remaining_months")
    present_value = fv_new_loan / (1 + ann_disc_rt / 12)**rm_new_loan
